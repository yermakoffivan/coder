...
- **Chatd**: Consult [Chatd Architecture](coderd/x/chatd/ARCHITECTURE.md) to
  understand the chatd subsystem. Update it when chatd changes affect the
  architecture. When updating that document, write for humans. Describe the
  architecture, not implementation details. Define necessary terms. Avoid
  jargon. Limit new sentences to 20 words.
