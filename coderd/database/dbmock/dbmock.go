...
// ChatClientMessageIDExists mocks base method.
func (m *MockStore) ChatClientMessageIDExists(ctx context.Context, arg database.ChatClientMessageIDExistsParams) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChatClientMessageIDExists", ctx, arg)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ChatClientMessageIDExists indicates an expected call of ChatClientMessageIDExists.
func (mr *MockStoreMockRecorder) ChatClientMessageIDExists(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChatClientMessageIDExists", reflect.TypeOf((*MockStore)(nil).ChatClientMessageIDExists), ctx, arg)
}
