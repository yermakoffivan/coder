...
func (q *querier) ChatClientMessageIDExists(ctx context.Context, arg database.ChatClientMessageIDExistsParams) (bool, error) {
	_, err := q.GetChatByID(ctx, arg.ChatID)
	if err != nil {
		return false, err
	}
	return q.db.ChatClientMessageIDExists(ctx, arg)
}
