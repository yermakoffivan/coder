...
FROM
    ...
    (
        VALUES
            (
                '565c0001-0000-4000-8000-000000000001'::uuid,
                'gpt-5.2',
                'Fixture Default 565',
                TRUE,
                TRUE,
            ...
            (
                '565c0002-0000-4000-8000-000000000002'::uuid,
                'gpt-5.2-mini',
                'Fixture Non Default 565',
                TRUE,
                FALSE,
                128000,
                70
            ...
            (
                '565c0003-0000-4000-8000-000000000003'::uuid,
                'gpt-4-legacy',
                'Fixture Deleted 565',
                FALSE,
                FALSE,
...
WHERE id = '565c0003-0000-4000-8000-000000000003';
