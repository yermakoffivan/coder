...
const AgentSettingsUserAgentsPage: FC = () => {
	...
	const chatModelsQuery = useQuery(availableChatModels(defaultOrganizationId));
	...
	const defaultOrgModelConfigs = modelConfigsQuery.data ?? [];
